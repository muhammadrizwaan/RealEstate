...
import { View, Text, ImageBackground, Image, TouchableOpacity, Alert , KeyboardAvoidingView} from 'react-native';
import { Input, Icon } from 'react-native-elements'
import { width, height, totalSize } from 'react-native-dimension';
import axios from 'axios';
import SpinnerScreen from '../Spinner';

class homeInspectorSignUp extends Component {
  constructor(props) {
    super(props);
    this.state= {
      CompanyName:'',
  ...
  onSignup(CompanyName, Name, CellPhone, email, password){
    try{
        ...
        return;
          ...
          axios.post(`http://www.tohfayhut.com/realestate/public/api/registerinspector`,
          {
    ...
    return (
      ...
      <ImageBackground source={require('./../../images/app2.png')} style={{width:width(100), height:height(100)}}>
        ...
        <Icon
            ...
            size={45}
          />
          <Text style={{fontSize:17, color:'#E61E26', }}>Home Inspector</Text>
        </View>
          <Input
          ...
          />        
              {this.renderButton()} 
                {/* <TouchableOpacity style={{marginVertical:height(5),borderRadius:45,width:width(75), height:height(8), marginHorizontal:width(9),  justifyContent:'center',alignItems:'center',backgroundColor:'#E61E26'}}>
                    <Text style={{color:'white', fontSize:18,alignSelf:'center',  }} onPress={()=>{this.props.navigation.navigate('homeInspectorSignIn')}}>SignUp</Text>
                  </TouchableOpacity> */}
        </View>
        </ImageBackground>
...
export default homeInspectorSignUp;
